...
Build app UI in `src/`. This project targets Vercel as a static Vite site. Keep the production output provider-neutral at `dist/index.html`; do not add ChatGPT Sites packaging or worker wrappers unless the user explicitly requests that provider for this project.
